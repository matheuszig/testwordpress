...
function ecommerce_storefront_customizer_settings( $wp_customize ) {
	...
	'label' => __('Image Height (Minimum)','new-york-business' ),
...
function ecommerce_storefront_general_admin_notice(){
         ...
         $msg = sprintf('<div data-dismissible="disable-done-notice-forever" class="notice notice-info is-dismissible" ><p>
			 	...
			 	<a href="?ecommerce_storefront_notice_dismissed" target="_self"  style="text-decoration: none; margin-left:10px;" class="button button-secondary">%7$s</a>
				...
				esc_html__('Tutorials free Demo','ecommerce-storefront'),
				esc_html__('Dismiss', 'ecommerce-storefront'),
				esc_html__('Customize -> Theme Option, Customize Slider, Navigation, Header Contacts, Banner sections, Header Widgets ', 'ecommerce-storefront'));				
		 echo wp_kses_post($msg);
}

if ( isset( $_GET['ecommerce_storefront_notice_dismissed'] ) ){
	update_option('ecommerce_storefront_notice', -1);
}

$ecommerce_storefront_notice = get_option('ecommerce_storefront_notice', 1);
